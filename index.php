            ...
            <section class="body">
                <form id="date_form">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control from " name="from" required>
                                    <option enable>--PickUp Point--</option>
                                    <option value="Pwani Uni">Surat</option>
                                    <option value="TUM">Junagadh</option>
                                    <option value="Voi">Gandhinagr</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                <label>To</label>
                                <input type="text" class="form-control to" name="to" placeholder="To" value="Mumbai"
                                    readonly>
                            </div>
                        </div>
                        <div class="form-row">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 bus-details">
                                                    <h5 class="card-title bus-name"> RAJWADI (<span
                                                    ...
                                                    <div class="p-t-13">
                                                        ...
                                                        <div class="gallery1" style="display: none;">
                                                            <a href="gallery/majaoni1.jpg">
                                                                <img src="gallery/majaoni1.jpg" alt=""
                                                                    title="Majaoni Secondary Bus" />
                                                            </a>
                                                            <a href="gallery/majaoni2.jpg">
                                                                <img src="gallery/majaoni2.jpg" alt=""
                                                                    title="Majaoni Secondary Bus" />
                                                            </a>
                                                            <a href="gallery/majaoni3.jpg">
                                                                <img src="gallery/majaoni3.jpg" alt=""
                                                                    title="Majaoni Secondary Bus" />
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 bus-details">
                                                        <h5 class="card-title bus-name">MADHURAM (<span
                                                        ...
                                                        <div class="p-t-13">
                                                            <a href="#"
                                                                class="btn btn-circle btn-success enable book_btn">Book
                                                                Seats</a>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 bus-details">
                                                        <h5 class="card-title bus-name">SANTKRUPA (<span
                                                                class="bus-type">49</span> Seater)</h5>
                                                        <div class="row card-text m-b-10 bus-description">
                                                            <div class="col-md-6 fs-14">
                                                                <i class="material-icons"
                                                                    style="font-size: 13px;">watch</i> Departure: <span
                                                                    class="p-r-5 fr">21:30hr </span>
                                                            </div>
                                                            <div class="col-md-6 fs-14">
                                                                <i class="fa fa-road"></i> Route:
                                                                <span class="p-r-5 fr">Nairobi - Mombasa </span>
                    ...
                    <fieldset class="animated fadeIn p-info">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" id="phone" name="phone" id="phone"
                                    placeholder="" onkeyup="verifyInfoForm()">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="email">Email</label>
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="john@doe.com" onkeyup="verifyInfoForm()">
                            </div>
                        </div>
                        <div class="row justify-content-center buttons">
                            <button type="button " class="btn previous_button">Back</button>
                    ...
                    <fieldset class="animated fadeIn p-info">
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-10">
                                <h6>
                                    ...
                                    A Printable PDF ticket will be sent to your email (<span class="show-email"></span>)
                                    upon payment completion. So please ensure you provide a valid email address.
                                    <br><br>
                                    <span class="note">Note: If you havent made a deposit by 3 days your reservation
                                        will be cancelled.</span>
                                </h6>
                            </div>
                        </div>
                        ...
                        <!-- <div class="row justify-content-center buttons">
                            <button type="button " class="btn previous_button">Back</button>
                            <button onclick="send_mail('kspvekariya1905@gmail.com', 'Your Subject Here', 'Your Message Here');
                            " type="button " class="btn next_button">Finish</button>
                        </div> -->

                        <div class="row justify-content-center buttons">
                            <button type="button" class="btn previous_button">Back</button>
                            <!-- Call the send_mail function when the Finish button is clicked -->
                            <button onclick="sendEmail()" type="button" class="btn next_button">Finish</button>
                        </div>
                    </fieldset>
                    <!-- END PAYMENT -->
                    <!-- TICKET -->
                    <fieldset class="animated fadeIn p-info">
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-8">
                                <h6>
                                    An email has been sent to your email address (<span class="show-email"></span>).
                                    Don't forget to look in your spam folder. Safe Journey <i
                                        class="fa fa-heart text-danger"></i>.<br><br>
                                    <span class="note">Note: If you havent made a deposit by days your reservation will
                                        be cancelled.</span>
                                </h6>
                            </div>
                        </div>
...
<?php
$to = "mendaparavasu8483@gmail.com";
$subject = "Test Email";
...
<script>
    // Assuming you have a form for payment and a submit button
    ...
    submitButton.addEventListener('click', (event) => {
        ...
        const paymentSuccessful = validateAndProcessPayment();

        if (paymentSuccessful) {
            // Payment was successful, send email
            sendConfirmationEmail('kspvekariya1905@gmail.com', 'Your Subject Here', 'Your Message Here');
        } else {
    ...
    function validateAndProcessPayment() {
        // Implement your payment validation and processing logic here
        // Return true if the payment is successful, false otherwise
        return true; // Replace with your actual payment validation and processing
    }
</script>
...
<script type="text/javascript">
    ...
    function sendEmail() {
        emailjs.send('service_wbw7jud', 'template_027hxam', {
            from_name: 'John Doe',
            to_name: 'Jane Smith',
            message: 'Hello, this is a test email.',
        })
